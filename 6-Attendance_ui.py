...
draw.rounded_rectangle((50, 120, 630, 560), radius=10, fill=PANEL_COLOR_LIGHT_BLUE) # Large Left Panel
draw.rounded_rectangle((650, 80, 1230, 700), radius=10, fill=PANEL_COLOR_LIGHT_BLUE) # Right Panel
draw.rounded_rectangle((750, 90, 1130, 140), radius=10, fill=HEADER_COLOR_DARK_BLUE) # Course ID Box

# --- Draw Bottom Boxes (Final Layout from your screenshot) ---
draw.rounded_rectangle((60, 580, 340, 690), radius=10, fill=BG_COLOR, outline=HEADER_COLOR_DARK_BLUE, width=2) # Left "Total Present" box
draw.rounded_rectangle((350, 580, 620, 690), radius=10, fill=BG_COLOR, outline=HEADER_COLOR_DARK_BLUE, width=2) # Left "Status" box
# NEW: Centrally located Time/Date box
draw.rounded_rectangle((770, 622, 1130, 690), radius=10, fill=HEADER_COLOR_DARK_BLUE)
